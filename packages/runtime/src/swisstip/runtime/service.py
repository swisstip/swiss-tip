...
INSTRUCTIONS_GRAPH = ("Swiss TIP serves published, cited facts from official Swiss sources; it composes no answers. "
                      ...
                      "who carries them out and decides, the office at the user's place, the laws and the pitfalls, "
                      "whether the answer depends on the canton or municipality, and what to search for. In the "
